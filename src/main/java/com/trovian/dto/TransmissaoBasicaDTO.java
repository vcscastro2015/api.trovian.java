...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "DTO para representação de Transmissão Básica")
public class TransmissaoBasicaDTO {

    @Schema(description = "ID da transmissão básica", example = "1", accessMode = Schema.AccessMode.READ_ONLY)
    private Long id;
    ...
    @Schema(description = "Pânico visualizado", example = "false")
    private Boolean panicoVisualizado;

    @Schema(description = "Pânico desativado", example = "false")
